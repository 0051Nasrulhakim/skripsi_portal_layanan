...
<!-- upload pada form -->
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-9">
            <input type="file" class="form-control" id="struktur_bkk" name="struktur_bkk" accept="application/pdf">
        </div>
    </div>
    <div class="mb-3 row">
        <label for="akta_pendirian_bkk" class="col-sm-3 col-form-label">Akta Pendirian BKK</label>
        <div class="col-sm-9">
            <input type="file" class="form-control" id="akta_pendirian_bkk" name="akta_pendirian_bkk" accept="application/pdf">
        </div>
    </div>
    <div class="mb-3 row">
        <label for="rencana_kerja_bkk" class="col-sm-3 col-form-label">Rencana Kerja Tahunan</label>
        <div class="col-sm-9">
            <input type="file" class="form-control" id="rencana_kerja_bkk" name="rencana_kerja_bkk" accept="application/pdf">
        </div>
    </div>
    <div class="mb-3 row">
        <label for="dokumen_pendirian_bkk" class="col-sm-3 col-form-label">Dokumen Pendirian</label>
        <div class="col-sm-9">
            <input type="file" class="form-control" id="dokumen_pendirian_bkk" name="dokumen_pendirian_bkk" accept="application/pdf">
        </div>
    </div>
    <div class="mb-3 row">
...
<!-- samping kanan form -->
    ...
    <ol>
        ...
        <li><strong>SEMUA BERKAS HARUS BERFORMAT PDF</strong></li>
